...
$sql = "SELECT p.id, p.total, p.pagamento, u.nome, u.email 
        FROM pedidos p 
...
$sql_itens = "SELECT pi.quantidade, pi.preco_unitario, pr.nome 
...
<div class="container">
  ...
  <p>Obrigado, <strong><?= htmlspecialchars($pedido['nome']) ?></strong>. Seu pedido foi realizado com sucesso.</p>
  ...
  <a href="../index.php" class="nav-item nav-link">Pagina principal</a>      
</div>
